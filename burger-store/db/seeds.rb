...
# ny_shipment = Shipment.create location_id: ny.id

# denver_shipment_patties =
#     Supply.create name: "patties", weight: 20, shipment_id: denver_shipment.id
# denver_shipment_buns1 =
#     Supply.create name: "buns", weight: 1, shipment_id: denver_shipment.id
# denver_shipment_buns2 =
#     Supply.create name: "buns", weight: 1, shipment_id: denver_shipment.id
# denver_shipment_fries =
#     Supply.create name: "fries", weight: 25, shipment_id: denver_shipment.id
# ny_shipment_patties =
#     Supply.create name: "patties", weight: 20, shipment_id: ny_shipment.id
